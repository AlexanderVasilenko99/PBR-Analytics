        ...
        <table className="ComparisonTable">
            ...
            {props && <><thead>
                ...
                <tbody>
                    <tr>
                        <th>מזהה ישוב (id)</th>
                        {x && x.map(s => <td key={s?.סמל_ישוב}>{s?.סמל_ישוב}</td>)}
                    </tr>
                    <tr>
                        <th>לשכת מנ"א ומזהה</th>
                        {x && x.map(s => <td key={s?.לשכת_מנא}>{s?.לשכת_מנא} {s?.קוד_לשכת_מנא}</td>)}
                    </tr>
                    <tr>
                        <th>מועצה אזורית ומזהה</th>
                        {x && x.map(s => <td key={s?.מועצה_אזורית}>{s?.מועצה_אזורית} {s?.קוד_מועצה_אזורית}</td>)}
                    </tr>
                    <tr>
                        <th>סה"כ תושבים</th>
                    ...
                    <tr>
                        ...
                        {x[0] && x.map(s => <td key={s?.גיל_0_5 + '%'}>{(s?.גיל_0_5 * 100 / s?.סהכ).toFixed(1)}%</td>)}
                    </tr>
                    <tr>
                        <th>אחוז גילאי 6-18</th>
                        {x[0] && x.map(s => <td key={s?.גיל_6_18 + '%'}>{(s?.גיל_6_18 * 100 / s?.סהכ).toFixed(1)}%</td>)}
                    </tr>
                    <tr>
                        <th>אחוז גילאי 19-45</th>
                        {x[0] && x.map(s => <td key={s?.גיל_19_45 + '%'}>{(s?.גיל_19_45 * 100 / s?.סהכ).toFixed(1)}%</td>)}
                    </tr>
                    <tr>
                        <th>אחוז גילאי 46-55</th>
                        {x[0] && x.map(s => <td key={s?.גיל_46_55 + '%'}>{(s?.גיל_46_55 * 100 / s?.סהכ).toFixed(1)}%</td>)}
                    </tr>
                    <tr>
                        <th>אחוז גילאי 56-64</th>
                        {x[0] && x.map(s => <td key={s?.גיל_56_64 + '%'}>{(s?.גיל_56_64 * 100 / s?.סהכ).toFixed(1)}%</td>)}
                    </tr>
                    <tr>
                        <th>אחוז גילאי 65+</th>
                        {x[0] && x.map(s => <td key={s?.גיל_65_פלוס + '%'}>{(s?.גיל_65_פלוס * 100 / s?.סהכ).toFixed(1)}%</td>)}
                    </tr>
                </tbody>
            </>
            }
